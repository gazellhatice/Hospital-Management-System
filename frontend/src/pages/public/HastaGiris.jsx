      ...
      <section className="w-full max-w-md bg-white/80 backdrop-blur-sm border border-emerald-200 rounded-2xl shadow-[0_24px_64px_-8px_rgba(0,0,0,0.12)] p-6 sm:p-8 flex flex-col gap-6">
        ...
        <header className="flex flex-col gap-2">
          ...
          <p className="text-[13px] text-gray-500 leading-relaxed flex items-start gap-2">
            ...
            <span>
              Randevularım, Reçetelerim ve Şikayet Takibim tek panelde. Giriş
        ...
        {hata && (
          <div className="flex items-start gap-3 rounded-lg border border-rose-200 bg-rose-50/70 px-4 py-3 text-[13px] text-rose-700 shadow-sm">
            ...
            <div className="leading-snug">
              <div className="font-semibold text-rose-700">Giriş başarısız</div>
              <div className="text-rose-700/90">{hata}</div>
              <div className="text-[11px] text-rose-500/80 mt-1 leading-snug">
                E-posta / şifre eşleşmiyor olabilir.
              </div>
            </div>
          </div>
        )}
        ...
        {okMesaj && (
          <div className="flex items-start gap-3 rounded-lg border border-emerald-200 bg-emerald-50/70 px-4 py-3 text-[13px] text-emerald-700 shadow-sm">
            ...
            <div className="leading-snug">
              <div className="font-semibold text-emerald-700">Giriş başarılı</div>
              <div className="text-emerald-700/90">{okMesaj}</div>
            </div>
          </div>
        )}
          ...
          <div className="text-sm">
            ...
            <div className="relative">
              <input
                ...
                ${email.length === 0 ? "border-gray-300 focus:ring-emerald-500 focus:border-emerald-500" : isEmailValid ? "border-emerald-300 focus:ring-emerald-500 focus:border-emerald-500" : "border-amber-300 focus:ring-amber-500 focus:border-amber-500"}`}
          ...
          <div className="text-sm">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full rounded-lg border bg-white px-3 py-2.5 pr-10 text-sm text-gray-900 shadow-sm outline-none placeholder:text-gray-400 focus:ring-2 transition
                ${sifre.length === 0 ? "border-gray-300 focus:ring-emerald-500 focus:border-emerald-500" : isPwdValid ? "border-emerald-300 focus:ring-emerald-500 focus:border-emerald-500" : "border-amber-300 focus:ring-amber-500 focus:border-amber-500"}`}
                placeholder="******"
                value={sifre}
            ...
            {capsOn && (
              <div className="mt-2 text-[11px] text-amber-600 leading-snug">
        ...
        <div className="text-[11px] text-gray-400 leading-snug text-center">
          Bu panel kişisel sağlık bilgilerinizi içerir. Ortak bilgisayarlarda
          işiniz bittikten sonra çıkış yapmayı unutmayın.
        </div>
      </section>
    </div>
  );
